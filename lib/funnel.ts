...
export const FUNNEL_STEPS = ["signin_start", "signin_new", "signin_returning", "signin_error", "first_dashboard", "cli_linked", "invite_copy", "invite_join", "mcp_call", "vs_create", "vs_view"] as const;
