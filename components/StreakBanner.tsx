...
/** A streak milestone, once: the server has already recorded it as shown, so dismiss only hides it here. */
export function StreakBanner({ days, shareHref }: { days: number; shareHref: string }) {
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 border-2 border-dark px-4 py-3 mb-8 font-mono text-xs">
      <span>
        &gt; <span className="text-white font-bold">{days}-day streak</span>
      </span>
