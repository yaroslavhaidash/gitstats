...
const STORED: [string, string][] = [
  ...
  ["visits", "We count page visits without cookies and keep GitHub handles typed into the site, with where the visit came from, and, for new accounts, which page and link they came from."],
